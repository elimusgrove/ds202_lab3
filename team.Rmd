...
#### Interesting enough, biology would rule that men should be fathering more children than women are, but it appears to be going the other way according to this. Though there isn't a strong differentiation between any of the political parties, which is what I really wanted to see.
